  ...
  return (
    <NavigationContainer ref={navigationRef}>
      <Stack.Navigator headerMode="screen">
        ...
        {TopPageData       && <Stack.Screen name='MiniApps'     component={TopPageData.MiniApps}  options={{...TransitionPresets.ModalPresentationIOS ,headerTitleAlign:"center",headerShown: false, animationEnabled: true }}/>}
